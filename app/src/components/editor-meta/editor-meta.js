        ...
        return (
            <div id={target} uk-modal='true' container="false" >
                <div className="uk-modal-dialog uk-modal-body">
                    <h2 className="uk-modal-title">Реактирование Мета-тэгов</h2>
                    ...
                    <p className="uk-text-right">
                        ...
                        <button className="uk-button uk-button-primary  uk-modal-close" type="button" onClick={() => applyMeta()}>Применить</button>
                    </p>
                </div>
            </div>
        )
